    ...
    <div class="login">
        <div v-if="isLoginPage"
            ...
            <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8 space-y-8 relative overflow-hidden">
                ...
                <div>
                    <img src="../assets/logo.png" alt="RBAC Logo"
                        class="mx-auto h-16 w-auto mb-4 rounded-full shadow-lg">
...
// 系统数据
const logoUrl =
    "https://readdy.ai/api/search-image?query=A%20modern%20minimalist%20logo%20for%20an%20RBAC%20permission%20management%20system%2C%20featuring%20a%20shield%20or%20lock%20icon%20with%20blue%20color%20scheme%2C%20clean%20lines%2C%20professional%20appearance%2C%20suitable%20for%20enterprise%20software%2C%20on%20a%20white%20background&width=200&height=200&seq=1&orientation=squarish";
</script>
