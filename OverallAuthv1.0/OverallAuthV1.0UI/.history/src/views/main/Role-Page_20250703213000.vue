    ...
    <el-dialog v-model="dialogVisible" title="添加角色" width="30%" draggable center>
        <el-form :model="Dialogform" label-width="120px">
            ...
            <el-form-item label="菜单">
                <el-tree style="max-width: 600px" :props="props" lazy show-checkbox @check-change="handleCheckChange" />
            </el-form-item>
...
const loadNode: LoadFunction = (node, resolve) => {
    ...
    let hasChild = false
    if (node.data.name === 'Home' || node.data.name === 'menu' || node.data.name === 'Role') {
        hasChild = false
